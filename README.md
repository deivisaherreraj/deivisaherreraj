...
Soy Deivis Andres Herrera Julio, un apasionado/a del desarrollo de software y la tecnología. Me encanta explorar nuevas ideas y trabajar en proyectos emocionantes. Aquí puedes encontrar una variedad de proyectos en los que he estado trabajando.
...
- Lenguajes de Programación: C# y PHP.
- Tecnologías: HTML5, CSS3, Angular, .NET Core (C#), Node.js (JavaScript, TypeScript) y Bootstrap (CSS/JS).
- Herramientas de Control de Versiones: Git, DevOps y TortoiseGit.
- Entornos de Desarrollo Integrado (IDEs): Visual Studio 2022, Visual Studio Code y Sublime Text.
- Bases de Datos: MySQL, PostgreSQL, MongoDB (NoSQL), Microsoft SQL Server, Oracle Database y Redis (NoSQL).
- Plataformas de Nube: Microsoft Azure, GCP (Google Cloud Platform).
- Metodologías de Desarrollo: Ágil (Scrum) y DevOps.

## 🌱 Estoy Aprendiendo

Actualmente, estoy enfocado/a en mejorar mis habilidades en Python (Django, Reflex), .NET MAUI (C#), React.js, Vue.js, Electron.js, Docker, Kubernetes.
...
¡Gracias por visitar y espero verte pronto! 👋 😊
